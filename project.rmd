...
lm_df <- na.omit(lm_df)
lm2 <- lm(GDP ~ Year + labour_data + education_in_govt_exp + labor_productivity, data = lm_df)
car::vif(lm2)
# Plot linear regression model
plot(lm_df$GDP, fitted(lm2), main = "Linear Regression Model", xlab = "Actual Values", ylab = "Predicted Values")
plot(lm2)
